...
_G.packer_plugins = {
  ...
  ["dragvisuals.vim"] = {
    ...
    url = "https://github.com/jondkinney/dragvisuals.vim"
  },
  ["emmet-vim"] = {
    loaded = true,
  ...
  ["refactoring.nvim"] = {
    loaded = true,
    path = "/Users/petermai/.local/share/nvim/site/pack/packer/start/refactoring.nvim",
  ...
  ["vim-tailwindcss"] = {
    ...
    url = "https://github.com/mrdotb/vim-tailwindcss"
  },
  ["vim-textobj-line"] = {
    loaded = true,
