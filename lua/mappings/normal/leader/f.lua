...
local extensions_telescope = [[<cmd>lua require('extensions.telescope').]]

local f = {
  name = "+Telescope",
  a = { extensions_telescope.. [[search_all_files()<cr>]],               "All files" },
  ...
  g = { telescope_extensions.. [[live_grep_args.live_grep_args()<cr>]],  "Live grep" },
