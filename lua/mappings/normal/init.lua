...
local spec = {
  ...
  { "<leader>dfc", telescope_extensions.dap.commands,         desc = "Commands" },
  { "<leader>dff", telescope_extensions.dap.frames,           desc = "Frames" },
  { "<leader>dfl", telescope_extensions.dap.list_breakpoints, desc = "List Breakpoints" },
  { "<leader>dfo", telescope_extensions.dap.configurations,   desc = "Configurations" },
  { "<leader>dfv", telescope_extensions.dap.variables,        desc = "Variables" },
