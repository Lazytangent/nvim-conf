local spec = {
  ...
  { "<leader>,p", "<cmd>lua require('yabs'):run_task('pre_commit')<cr>:e<cr>", desc = "Run pre-commit on current file" },
  ...
  { "<leader>fA", "<cmd>lua require('telescope').extensions.frecency.frecency()<cr>", desc = "Frecency" },
  ...
  { "<leader>fy", "<cmd>Telescope yabs tasks<cr>", desc = "Yabs" },
  { "<leader>g", group = "Git" },
  ...
  { "<leader>mM", desc = "Swap with previous method/function" },
  ...
  { "<leader>mm", desc = "Swap with next method/function" },
  ...
  { "<leader>na", "<cmd>lua require('neotest').run.attach()<cr>", desc = "Attach to nearest test" },
  ...
  { "<leader>nm", group = "Summary" },
  { "<leader>nmc", "<cmd>lua require('neotest').summary.close()<cr>", desc = "Close summary" },
  { "<leader>nmm", "<cmd>lua require('neotest').summary.toggle()<cr>", desc = "Toggle summary" },
  { "<leader>nmo", "<cmd>lua require('neotest').summary.open()<cr>", desc = "Open summary" },
  { "<leader>nmt", "<cmd>lua require('neotest').summary.toggle()<cr>", desc = "Toggle summary" },
  { "<leader>nn", "<cmd>lua require('neotest').jump.next({ status = 'failed' })<cr>", desc = "Next failed" },
  { "<leader>no", "<cmd>lua require('neotest').output.open({ enter = true })<cr>", desc = "Open output" },
  { "<leader>np", "<cmd>lua require('neotest').jump.prev({ status = 'failed' })<cr>", desc = "Prev failed" },
  { "<leader>ns", "<cmd>lua require('neotest').run.stop()<cr>", desc = "Stop test" },
  { "<leader>nt", "<cmd>lua require('neotest').run.run()<cr>", desc = "Nearest test" },
  { "<leader>o", group = "Open" },
  ...
  { "<leader>rc", "<cmd>lua require('refactoring').debug.cleanup({})<cr>", desc = "Clean up" },
  { "<leader>rf", "<cmd>lua require('refactoring').refactor('Extract Block To File')<cr>", desc = "Extract block to file" },
  ...
  { "<leader>rv", "<cmd>lua require('refactoring').debug.print_var({ normal = true })<cr>", desc = "print_var" },
